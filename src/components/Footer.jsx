        ...
        <div className="flex justify-between flex-wrap ">
              ...
              <li className="flex items-center">
                <svg
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M3 10l1.2 10.8a2 2 0 002 1.7h11.6a2 2 0 002-1.7L21 10M5 10V6a4 4 0 014-4h6a4 4 0 014 4v4"></path>
                </svg>
              ...
              <li className="flex items-center">
                <svg
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M16 17l-4-4m0 0l-4-4m4 4h12M7 7h5a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2z"></path>
                </svg>
          ...
          <div className="col-span-1">
            ...
            <form className="flex h-12 relative">
              ...
              <button
                type="submit"
                className="px-4 py-2  absolute top-0 bottom-0 -right-[0.125rem] rounded-full bg-indigo-600 text-white  hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                Subscribe
              </button>
            </form>
          </div>
